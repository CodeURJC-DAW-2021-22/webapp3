...
public class UserRestController {
    ...
    @GetMapping("/members")
    public ResponseEntity<List<User>> getMembers(Pageable page) {
        return new ResponseEntity<>(usrServ.findPageClient(page.getPageNumber(), "member").getContent(), HttpStatus.OK);
    }
